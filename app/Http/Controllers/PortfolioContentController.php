...
class PortfolioContentController extends Controller
{
    ...
    public function index()
    {
        ...
        $pagecontent = PageGeneralContent::find(4);

        return view('pages.portfoliopage.index')->with(["portfoliocontent" => $portfoliocontent, "pagecontent" => $pagecontent]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $content = PortfolioContent::find($id);

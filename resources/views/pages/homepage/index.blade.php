...
<div class="container-fluid m-0 p-0">
    @include("pages.header", ["active" => "homepage"])
...
<div class="page-tabs-content bg-secondary">
        <div class="homepage">
            ...
            @foreach ($homecontent as $content)
                ...
                <div class="container-fluid p-5 page-section border-bottom" id="{{$content->id}}" name="homepage">
                    <p class="edit text-success text-center">Click to edit</p>
                    ...
                    <p id="section_description" class="text-white">{{$content->section_description}}</p>

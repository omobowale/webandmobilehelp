...
<div class="container-fluid m-0 p-0">
    @include("pages.header", ["active" => "portfoliopage"])
...
<div class="page-tabs-content bg-secondary">
        <div class="portfoliopage">
            ...
            @foreach ($portfoliocontent as $content)

                <div class="container-fluid p-5 page-section border-bottom" id="{{$content->id}}" name="portfoliopage">
                    <p class="edit text-success text-center">Click to edit</p>

...
<div class="modal offset-md-2 col-md-8" id="create-portfolio-modal">

    <form id="add-new-portfolio-form" method="post" action="/portfolio" enctype="multipart/form-data">
        @csrf
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title">Add New Portfolio</h3>
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" id="portfolio_image" name="portfolio_image" type="file" placeholder="Choose Image" required/>
                </div>
                <div class="form-group">
            ...
            <div class="modal-footer">
                <button type="submit" class="py-2 px-3 border general-bg">Add</button>
                <button type="button" data-dismiss="modal" data-target="#create-portfolio-modal" class="bg-danger py-2 px-3 border">Cancel</button>
            </div>  
        </div>
    </form>
</div>